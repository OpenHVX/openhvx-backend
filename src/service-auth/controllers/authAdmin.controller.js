...
const User = require('../models/user.base.model');       // modèle de base (discriminatorKey: 'kind')
 ...
 *
 * - once  (défaut): 409 si l'email existe déjà
 * - reset : met à jour le passwordHash si l'user existe (et force kind=admin/roles/scopes)
 * - upsert: crée si absent, sinon met à jour (reset + create)
 */
exports.register = async (req, res) => {
    ...
    try {
        ...
        // On vérifie l'existence *tous kinds confondus*
        ...
        if (existing) {
            ...
            // reset/upsert → (re)positionne 'admin' et réécrit le hash
