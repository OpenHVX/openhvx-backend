 ...
 * - Optionnel: protège via X-API-Key si ACTIVÉ
 *   ENV: TENANT_REGISTER_APIKEY (si défini, exigé)
 */
exports.register = async (req, res) => {
    try {
        // Appliquer un garde simple par clé API si configuré
        ...
        // Empêcher l’élévation côté tenant
        ...
        const passwordHash = await bcrypt.hash(password, 12); // cost 12 (peut être ajusté)
